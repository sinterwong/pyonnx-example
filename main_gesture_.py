...
def main():
    ...
    gesture = GestureRecognition(opt.det_model_path, opt.cls_model_path, det_input_size=opt.det_input_size, cls_input_size=opt.cls_input_size,
                                 idx2classes=idx2classes, det_conf_thr=opt.det_conf_thr, det_iou_thr=opt.det_iou_thr)
    ...
    if opt.action_video_path:
        gesture.video_tracker_demo(
            opt.action_video_path, opt.out_root, is_show=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video_path", type=str,
                        default="/home/wangjq/wangxt/datasets/gesture-dataset/hand_dataset_record/video/004.mp4", help="video path")

...
if __name__ == "__main__":
    ...
    parser.add_argument("--type", type=str, default="regression", help="Currently supports ['darkpose', 'baseline', 'regression'], they difference is post-processing")
    parser.add_argument("--im_path", type=str, default="data/hand/002.jpg", help="single image path")

from combine import HumanActionRecognition
...
def main():
    ...
    pose = HumanActionRecognition(opt.det_model_path, opt.pose_model_path, det_input_size=opt.det_input_size, pose_input_size=opt.pose_input_size,
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--pose_input_size", type=tuple, default=(128, 96), help="input size")
    parser.add_argument("--pose_input_size", type=tuple, default=(256, 192), help="input size")
    parser.add_argument("--show_thr", type=float, default=0.35,
                        help="Threshold that needs to be displayed")
    parser.add_argument("--det_conf_thr", type=float, default=0.25,
    ...
    parser.add_argument("--video_path", type=str,
                        default="data/gesture.mp4", help="video path")
    parser.add_argument("--im_path", type=str,
                        default="data/person/010.jpg", help="single image path")
    parser.add_argument("--out_root", type=str,
                        default="data/main_result/action", help="result output folder")
    main()
